...
import { ToolNotFoundError, type ToolMetadata } from "@core/errors";
```
...
```typescript
// ✅ 正确的写法
import type { Tool, ToolMetadata } from "@core/types";
import type { z } from "zod";
...
```typescript
// ✅ 正确的写法
import type { BestMCPConfig } from "@core/types";
