...
import type { Server } from "@server/internal/mcp-sdk";
...
vi.mock("@server/internal/mcp-sdk", () => ({
...
describe("HTTPTransport", () => {
  ...
  beforeEach(async () => {
    ...
    const { StreamableHTTPServerTransport } = await import("@server/internal/mcp-sdk");
